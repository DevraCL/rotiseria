...
$galleries = fresh_fnc_get_post_galleries();
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="post-preview">
		...
		<div id="post-slide-<?php the_ID(); ?>" class="owl-carousel-play" data-ride="carousel">
			...
			<a class="left carousel-control" data-slide="prev" href="#post-slide-<?php the_ID(); ?>">
				<span class="fa fa-angle-left"></span>
			</a>
			<a class="right carousel-control" data-slide="next" href="#post-slide-<?php the_ID(); ?>">
