...
?>
<div class="blog-post">
	<div class="<?php echo esc_attr($blog_style); ?>-layout <?php echo esc_attr( implode( ' ', $css_class ) ) ;?>" data-owl-options='{"items" : <?php echo esc_attr( $columns ); ?>, "tablet" : 2, "mobile" : 1, "pagination": "yes"}'>
		 <?php  // wpopal_themer_get_template_part(); ?>
		 	...
		 	<?php
					...
					while ( $loop->have_posts()  ) : $loop->the_post();
						 ...
						 */
						get_template_part( 'content-widgetblog' );
