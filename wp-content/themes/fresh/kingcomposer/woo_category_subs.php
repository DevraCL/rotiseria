                ...
                <div class="category-filter-v1">
                    <div class="category-filter-content">
                        <h4 class="category-filter-title">
                         ...
                         <small><?php echo trim($term->count); ?> <?php esc_html_e( 'Products', 'fresh' );?></small>
                        ...
                        <div class="category-filter-link">
                            <a href="<?php echo esc_url( $category_link ); ?>" title="<?php esc_html_e( 'more', 'fresh'); ?>" class=""><?php esc_html_e( '+ more...', 'fresh' ); ?></a>
                        </div>
                    </div>
